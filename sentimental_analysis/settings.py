...
SECRET_KEY = 'django-insecure-mj($mej^3alj&ojdbpq$te4yac1-**cb=8^wxld0r3&elp_d5o'
...
#SMTP Confg:
#class that handles email sending to the smtp server
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
#this use email host which is gmail
EMAIL_HOST = 'smtp.gmail.com'
#this use for security (trasport layer security)-data is in encrypted form 
EMAIL_USE_TLS = True
#smtp port no 
EMAIL_PORT = 587
#email host user
